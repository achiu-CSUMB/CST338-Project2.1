...
|-------|-------|-----------------|--------|------------|-------|--------------------|--------|
| 1 — Accounts | John Ly | 6e4st | #7, #8, #9, #36, #39 | john/user-dao, john/account-scene | #15, #19, #35, #37, #38, #40 | Admin role and password reset | complete |
...
| 4 — Grades & Statistics |Alvin Chiu  |achiu-CSUMB |#1,#2,#3, #12 |alvin/FXskeleton, alvin/grade-ui, alvin/grade-and-DB, alvin/grade-Skeleton, alvin/statistics, alvin/assignmentsUpdate, alvin/CourseAssignmentGradePicker, alvin/gradeAdd, alvin/grade-final |#14,#17, #31,#55,#57 |TableView / ListView populated with live data |complete |
...
- Slice 4 - Weighted grades and GPA calc due to time constraints
